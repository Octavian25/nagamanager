...
class PieChartOutWidgetMobile extends StatefulWidget {
  const PieChartOutWidgetMobile({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => PieChartOutWidgetMobileState();
}

class PieChartOutWidgetMobileState extends State {
  int touchedIndex = -1;
  List<PieChartSectionData> data = [];
  @override
  void initState() {
